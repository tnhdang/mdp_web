...
const Banner = () => {
  return (
    <div className="w-full h-fit flex items-center content-center justify-center">
      <div className="pt-2 banner w-[66.67%] h-[90vh] pvmax:max-lg:h-[90vh] flex pvmax:max-lg:flex-col pvmax:max-lg:align-middle justify-center  ">
      ...
      <div className="flex flex-col w-[60%] pvmax:max-lg:w-[100%] h-[100%] pvmax:max-lg:h-[50%] gap-20 pvmax:max-lg:gap-10 text-start text-[1.1rem] justify-center ml-[10rem] pvmax:max-lg:ml-0 pvmax:max-lg:px-0 banner-content">
