...
const Banner = () => {
  return (
    <div className="pt-2 banner w-[100%] h-[90vh] flex   ">
      ...
      <div className="flex flex-col w-[35%] h-[100%] justify-center pl-[1rem] ">
      ...
      <div className="flex flex-col w-[40%] h-[100%] gap-20 text-start text-[1.1rem] justify-center ml-[10rem] banner-content">
