...
const EndSolutions = () => {
    ...
    return ( 
        <div className="EndSolutionContainer w-[100%] h-[80vh] pvmax:max-lg:h-[100vh] content-center grid grid-cols-2 md:max-xl:grid-cols-1 pv:max-md:grid-cols-1">
           <div className="w-full h-[100vh] pvmax:max-lg:h-fit flex flex-col justify-center">
                <p className="text-[1rem] text-start px-[4rem] font-bold">
              ...
              <div className="  w-full rounded-lg " key={item.key}>
                ...
                <div className="w-[80%] mx-auto pt-10 pvmax:max-lg:pt-14 pb-20">
                  <p className="text-[1.1rem]  text-white">
                    <span className="text-[1rem]  text-white font-bold">{item.title}</span>
                    "{item.description}"
                    <span className="text-[1rem]  text-[#170F58] font-bold">{item.highlight}</span>
                    <span className="text-[1rem]  text-white ">{item.description2}</span>
                  </p>
                </div>
              </div>
            );
