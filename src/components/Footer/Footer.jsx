...
const Footer = () => {
    return (
        <div className="container">
            ...
            <p className="text-start  leading-9 text-[1.1rem] "><span className="font-bold text-[1.2rem] no-underline">Email contract:  </span><a href="mailto: sales@mdpgroup.digital" className="underline">sales@mdpgroup.digital</a></p>
