...
const Footer = () => {
    return (
        <div className="container">
            ...
            <Row justify="start" align="top" className="pb-6">
                ...
                <p className="text-start pr-2  leading-9 font-bold text-[1.1rem]"> Headquarter:</p>
                    <p className="text-start pr-3 leading-6 text-[1rem]"> <span className="hidden pvmax:max-lg:inline">* </span>100 Le Lai street</p>
                ...
                <p className="text-start pr-2 pl-2 leading-9 font-bold text-[1.1rem]"> Development centre:</p>
                    ...
                    <p className="text-start px-2 leading-6 text-[1rem]">Ward 2, Tan Binh District</p>
                    <p className="text-start px-2 leading-6 text-[1rem]"> Ho Chi Minh city, VietNam</p>
                </Col>
                <Col xs={24} sm={24} md={24} lg={8} xl={8}>
                <p className="text-start pr-2 pl-2 leading-9 font-bold text-[1.1rem]"> Hanoi office:</p>
                    <p className="text-start px-2 leading-6 text-[1rem]"><span className="hidden pvmax:max-lg:inline">* </span>24 Ton Duc Thang street</p>
                    <p className="text-start px-2 leading-6 text-[1rem]">Cat Linh ward, Dong Da District</p>
                    <p className="text-start px-2 leading-6 text-[1rem]">Hanoi, VietNam</p>
      ...
      <button className="bg-[#4fb645] text-white py-2 px-4 text-base font-bold font-sans rounded-[2rem]">Contact us</button>
      </div>
            </div>
