...
import img2 from "../../../assets/BusinessLending/1.svg";
import img3 from "../../../assets/BusinessLending/2.svg";
import img4 from "../../../assets/BusinessLending/3.svg";
import img5 from "../../../assets/BusinessLending/4.webp";
    ...
    <>
      ...
      <Row justify="center" align="top" className="firstpart-lending">
        <Col xs={24} sm={24} md={24} lg={12} xl={12} className="firstpart-lending-left">
          ...
          <p>Whether you offer loans for businesses to start new operations or
            financing to support expansion and growth, Mambu provides the tools
            to build fully configurable business lending products that are tailored
            to the unique needs of commercial organisations and small and medium-sized enterprises.
          </p>
      ...
      {/* Second Big Row */}
      <Row gutter={[38, 0]} justify="center" align="middle" className="secondpart-businesslending">
        <Col xs={24} sm={24} md={24} lg={24} xl={24} className="">
          <h2>DELIVER DISTINCTIVE BUSINESS LENDING</h2>
          <h1>Configure. Connect. Grow.</h1>
          <div className="line"><div></div></div>
        </Col>
        <Col xs={24} sm={24} md={24} lg={8} xl={8} className="secondpart-businesslending-left">
          <div className="part2-card">
            <div className="img-part2"><img src={img2} /></div>
            <h2>Distinctive experience</h2>
            <p>Configure loan products to adapt and respond to the needs of your business customers.</p>
          </div>


        </Col>
        <Col xs={24} sm={24} md={24} lg={8} xl={8} className="secondpart-businesslending-right">
          <div className="part2-card">
            <div className="img-part2"><img src={img3} /></div>
            <h2>Connect technologies</h2>
            <p>Connect with best-for-purpose modern technology vendors to establish seamless, fully automated loan processes.</p>
          </div>
        </Col>
        <Col xs={24} sm={24} md={24} lg={8} xl={8} className="secondpart-businesslending-right">
          <div className="part2-card">
            ...
            <h2>Rapid scaling</h2>
            <p>Go to market quickly with scalable, low-code configurations, and well-fitting API connectors.</p>
          </div>
        </Col>
      </Row>
      ...
      <div className="part3-businesslending">
        <Row justify="center " align="middle" className="" >
          <h2 className="part3-businesslending-tittle1">FEATURES YOU WANT, WHEN YOU NEED THEM</h2>
        </Row>
        <Row justify="center " align="middle" className="" >
          <h1 className="part3-businesslending-tittle2">Innovate with pre-built product configurations</h1>
        </Row>
        <div className="line"><div></div></div>
        <p>The composable features and functionality of our lending engine mean you can use as-is or build on to meet your business needs.</p>
      ...
      <div className="part4-businesslending">
        ...
        >
          <SwiperSlide>
            <Row justify="center " align="top" className="businesslending-swyper-content" >
              <Col xs={24} sm={24} md={24} lg={12} xl={12} className="part4-businesslending-right">
                <img src={img5} />
              </Col>
              <Col xs={24} sm={24} md={24} lg={12} xl={12} className="part4-businesslending-left">
                <h1>Product level highlights</h1>

                <p><CheckOutlined />Define new product settings</p>
                <p><CheckOutlined />Set loan amounts and limits</p>
                <p><CheckOutlined />Set up interest rate and configure fees</p>
                <p><CheckOutlined />Create product link to deposit account for settlement</p>
                <p><CheckOutlined />Enable securities</p>
                <p><CheckOutlined />Capture additional details using custom fields</p>
        ...
        <SwiperSlide>
          <div className="part5-swiper-content">
            ...
            <p className="quotes">"Being cloud native, Mambu and its composable architecture gave us the foundation needed to seamlessly integrate with Allica’s own proprietary applications in our cloud based tech stack."</p>
              <Row justify="center" align="middle" gutter={[48, 24]} className="flex" >
