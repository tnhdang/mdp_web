...
const UseCases = () => {
    ...
    return (
        <>
            ...
            {/* 1 */}
            <div className="w-full h-[110vh] pvmax:max-md:h-fit p-12 h110">
                <div className="w-full h-[60%] flex pvmax:max-md:flex-col px-10 pvmax:max-md:px-0 pb-12">
                    <div className="w-[50%] pvmax:max-md:w-full h-[60vh] pvmax:max-md:h-fit text-start flex flex-col items-center">
                        <p className="text-[1rem] w-full font-mono text-slate-300 py-2">Use Cases</p>
                        <p className=" w-full pvmax:max-md:w-full pvmax:max-md:text-center pvmax:max-md:pb-10 font-semibold text-6xl text-[#4fb645]" >Digital Banking</p>
                    </div>
                    <div className="w-[50%]  pvmax:max-md:w-full h-[60vh] text-justify text-[1.1rem]">
                ...
                <div className="w-full h-[40%] pvmax:max-md:h-fit flex pvmax:max-md:flex-col px-8">
                    <div className="w-[50%] pvmax:max-md:w-full h-[40vh] pvmax:max-md:h-fit pr-8 pvmax:max-md:pr-0">
            ...
            {/* 2 */}
            <div className="w-full h-[100vh] pvmax:max-md:h-fit flex flex-row pvmax:max-md:flex-col py-20 pvmax:max-md:py-0 pvmax:max-md:px-8 px-20 h100">
                ...
                <div className="w-[50%] pvmax:max-md:w-full h-[100%] flex flex-col justify-center align-middle">
                    ...
                    <p className="w-[70%] pvmax:max-md:w-full text-start pvmax:max-md:text-center text-6xl text-[#4fb645] pb-8 font-semibold">Digital Payment</p>
                ...
                <div className="w-[50%] pvmax:max-md:w-full h-[100%] py-10 pl-40 pvmax:max-md:pl-0">
                    <img className="w-full h-full rounded-[1rem]" src="https://img.freepik.com/free-vector/online-banking-isometric-web-page_1284-29561.jpg?t=st=1709004607~exp=1709008207~hmac=a0ca102ecfc944cb0c7b9ac3db1f7986d752b0894dc8691d55562d4876597736&w=740"></img>
                </div>
            </div>
            {/* 3 */}
            <div className="w-full h-[110vh] pvmax:max-md:h-fit p-12 h110 ">
                <div className="w-full h-[60%] flex pvmax:max-md:flex-col px-10 pvmax:max-md:px-0 pb-12">
                    <div className="w-[50%] pvmax:max-md:w-full h-[60vh] pvmax:max-md:h-fit text-start flex flex-col items-center">
                        <p className="text-[1rem] w-full font-mono text-slate-300 py-2 ">Use Cases</p>
                        <p className=" w-full pvmax:max-md:w-full pvmax:max-md:text-center pvmax:max-md:pb-10 font-semibold text-6xl text-[#4fb645]" >Consumer Lending</p>
                    </div>
                    <div className="w-[50%] pvmax:max-md:w-full h-[60vh] text-justify text-[1.1rem]">
            ...
            {/* 4 */}
            <div className="h100 w-full h-[100vh] pvmax:max-md:h-fit flex flex-row pvmax:max-md:flex-col py-20 pvmax:max-md:py-0 pvmax:max-md:px-8 px-20">


                <div className="w-[50%] pvmax:max-md:w-full h-[100%] pvmax:max-md:h-fit  py-10 pr-40 pvmax:max-md:pr-0">
                    <img className="w-full h-full rounded-[1rem]" src="https://img.freepik.com/free-vector/online-banking-isometric-web-page_1284-29561.jpg?t=st=1709004607~exp=1709008207~hmac=a0ca102ecfc944cb0c7b9ac3db1f7986d752b0894dc8691d55562d4876597736&w=740"></img>
                </div>
                <div className="w-[50%] pvmax:max-md:w-full h-[100%] flex flex-col justify-center align-middle">
                    <p className="text-[1rem] pvmax:max-md:w-full font-mono text-slate-300 py-2 text-start pvmax:max-md:text-center">Use Cases</p>
                    <p className="w-[70%] pvmax:max-md:w-full text-start pvmax:max-md:text-center text-6xl text-[#4fb645] pb-8 font-semibold">SME Lending</p>
            ...
            <div className="w-full h-[110vh] pvmax:max-md:h-fit p-12 h110 ">
                ...
                <div className=" pvmax:max-md:w-full h-[60vh] pvmax:max-md:h-fit hidden  pvmax:max-md:flex  pvmax:max-md:flex-col items-center">
                        ...
                        <p className="w-full text-end  pvmax:max-md:w-full pvmax:max-md:text-center pvmax:max-md:pb-10 font-semibold text-6xl text-[#4fb645]" >Merchant Lending</p>
                    </div>
                    <div className="w-[50%]  pvmax:max-md:w-full h-[60vh] text-justify text-[1.1rem] flex flex-col items-center">
                    ...
                    <div className="w-[50%] pvmax:max-md:w-full h-[60vh] pvmax:max-md:h-fit  pvmax:max-md:hidden text-start flex flex-col items-center">
            ...
            <div className="h100 w-full h-[100vh] pvmax:max-md:h-fit flex flex-row pvmax:max-md:flex-col py-20 pvmax:max-md:py-0 pvmax:max-md:px-8 px-20">
                ...
                <div className="w-[50%] pvmax:max-md:w-full h-[100%] flex flex-col justify-center align-middle">
                    <p className="text-[1rem] font-mono text-slate-300 py-2 text-start pvmax:max-md:text-center">Use Cases</p>
                    <p className="w-[70%] pvmax:max-md:w-full text-start pvmax:max-md:text-center text-6xl text-[#4fb645] pb-8 font-semibold">eKYC Platform</p>
                    <p className="text-justify text-[1.1rem]">
            ...
            {/* 7 */}
            <div className="w-full h-[120vh] pvmax:max-md:h-fit p-12 h110">
                <div className="w-full h-[60%] flex pvmax:max-md:flex-col px-10 pvmax:max-md:px-0 pb-12">
                    <div className="w-[50%] pvmax:max-md:w-full h-[60vh] pvmax:max-md:h-fit text-start flex flex-col items-center">
                        <p className="text-[1rem] font-mono text-slate-300 py-2">Use Cases</p>
                        <p className="w-[60%] w-full pvmax:max-md:w-full pvmax:max-md:text-center pvmax:max-md:pb-10 font-semibold text-6xl text-[#4fb645]" >Open Banking</p>
                    </div>
                    <div className="w-[50%]  pvmax:max-md:w-full h-[60vh] text-justify text-[1.1rem]">
...
Enhanced Customer Experience: Access to a wider range of financial products, services, and personalized experiences through third-party integrations and partnerships, enriching the overall customer experience.
            ...
            <div className="w-[100%] mx-auto pl-[8rem] pvmax:max-lg:pl-[2rem] py-10 md:max-xl:w-[90%] pv:max-md:w-[90%] solution-intro">
                <p className="text-[1.1rem] font-bold text-start w-[95%] py-10 pvmax:max-lg:py-5 md:max-xl:w-[90%] pv:max-md:w-[100%] big-description-Services  ">
