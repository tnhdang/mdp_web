...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <div className="w-[75%] mx-auto cursor-pointer pt-10 pb-20">
        <img
      ...
      {/* Section Card Tab */}
      <div className="flex w-[75%] mx-auto gap-10 ">
        <button
      ...
      <CardTabs
        className={` ${
          isTab1 ? "grid" : "hidden"
        } grid-cols-2 bg-[#eeeeee] shadow-lg shadow-gray-300 w-[75%] py-10 mx-auto my-10 rounded-lg`}
      ...
      <div className="w-[70%] mx-auto  grid grid-cols-3 gap-16 mb-10">
      ...
      <div className="py-10">
        <p className="text-5xl font-bold">Mambu by the numbers</p>
      </div>
      <div className="grid grid-cols-3 gap-x-16 gap-y-28 pl-20 w-[75%] mx-auto">
      ...
      <div className="w-[75%] mx-auto grid grid-cols-4 pl-20 gap-20">
      ...
      <div className="bg-[#f5ebe1] py-32">
        <div className="grid grid-cols-2  mx-auto w-[75%]">
